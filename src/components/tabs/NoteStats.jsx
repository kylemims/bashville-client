...
export const NoteStats = ({ stats, projectTitle, onCloseStats }) => {
  ...
  return (
    <div className="note-stats-overlay">
      <div className="note-stats">
        <div className="stats-header">
          ...
          <button type="button" className="note-action-btn" onClick={onCloseStats} title="Close">
